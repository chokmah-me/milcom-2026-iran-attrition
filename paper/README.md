...
Repo-level DOI map: [../ZENODO.md](../ZENODO.md).

## Parent (v4)

Launcher attrition / magazine-discipline paper: concept [10.5281/zenodo.19210451](https://doi.org/10.5281/zenodo.19210451), version [10.5281/zenodo.19558494](https://doi.org/10.5281/zenodo.19558494).

## Supporting materials in this directory

- `leg3_preregistration_v0_2.md` — Leg 3 pre-registration (locked; Zenodo software pin [10.5281/zenodo.21443990](https://doi.org/10.5281/zenodo.21443990))
- `leg3_coding_tables_v0_2.md`, `leg2_retro_audit.md` — empirical coding
- Draft / PRE variants retained for provenance; **deposit of record is the FIXED PDF**
